...
Test DIFF Command QA
    ...
    Log                    🔍 DIFF: Comparando cambios tests
...
Test Workflow DIFF-COMMIT-PUSH
    ...
    Log                    ✅ Workflow QA: DIFF→COMMIT→PUSH

Test Git Commands Validation
    [Documentation]    Validación comandos Git esenciales
    Log                    🛠️ Validando comandos Git QA
    ...
    Log                    ✅ Comandos Git validados

Test TortoiseGit Interface
    [Documentation]    Validación interfaz TortoiseGit
    Log                    🖱️ Validando interfaz TortoiseGit
    ...
    Log                    ✅ Interfaz TortoiseGit validada</code></pre>
        
        <h3>🎯 Práctica Git QA (6 min):</h3>
        <p>1. Instalar TortoiseGit: tortoisegit.org → Download → Install</p>
        <p>2. Configurar QA: Right-click → Settings → Name: "QA Engineer"</p>
        <p>3. Crear repo: New Folder "robot-qa-tests" → Git Create Repository</p>
        <p>4. Crear test: login_test.robot con código Robot Framework</p>
        <p>5. **DIFF**: Modificar test → Right-click → TortoiseGit → **Diff**</p>
        <p>6. Interpretar: **Rojo=eliminado**, **Verde=agregado**</p>
        <p>7. **COMMIT**: Right-click → TortoiseGit → **Commit** → "QA: Added login"</p>
        <p>8. Mensaje formato: **"QA: [Acción] [Descripción]"**</p>
        <p>9. Ver historial: Right-click → Show Log → Ver commits</p>
        <p>10. Crear logout_test.robot → DIFF diferencias</p>
        <p>11. Commit múltiple: Select files → COMMIT mensaje QA</p>
        <p>12. **PUSH**: Right-click → TortoiseGit → **Push** → Remote</p>
        <p>13. Configurar remote: Push → Set URL GitHub/GitLab</p>
        <p>14. Push exitoso: Verificar "Success" → Tests en equipo</p>
        <p>15. Pull actualizar: Right-click → Pull → Bajar cambios equipo</p>
        <p>16. Workflow diario: **DIFF** → **COMMIT** → **PUSH** → Repetir</p>
        <p>17. Resolver conflictos: TortoiseGit → Resolve → Merge manual</p>
        <p>18. Branch QA: Switch/Checkout → Create "feature/new-tests"</p>

        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; margin: 15px 0;">
            <h4>✅ Objetivos:</h4>
            <ul>
                <li>Dominar workflow diario DIFF-COMMIT-PUSH para QA</li>
                <li>Configurar TortoiseGit para interfaz visual Git</li>
                <li>Interpretar cambios con colores diff (rojo/verde)</li>
                <li>Implementar convenciones QA para mensajes commit</li>
            </ul>
        </div>
        
        <div style="background: #fff3cd; padding: 10px; border-radius: 8px; margin: 10px 0;">
            <h4>💡 Tip:</h4>
            <p>DIFF antes commit = evitar código roto. PUSH diario = equipo sincronizado. Usa formato "QA: [Acción]".</p>
        </div>
        
        <h3>🚀 Siguiente: Lección 012 - Configuración de requirements.txt</h3>
        <p>Con Git workflow dominado, aprenderás gestión profesional de dependencias con requirements.txt versionado.</p>
    `,
